...
![GitHub all releases](https://img.shields.io/github/downloads/ariscript/multiserver/total?logo=Github&style=for-the-badge)
...
Please direct pull requests to the [main](https://github.com/ariscript/multiserver/tree/main) branch.
